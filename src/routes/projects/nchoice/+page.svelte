<div class="flex flex-wrap-reverse">
	<div class="w-full px-2 pt-20 md:w-2/3">
		...
		<enhanced:img src="/static/nchoice/5.jpg" alt="" class="mb-2 w-full rounded-md" />
		<div
		...
		<enhanced:img src="/static/nchoice/ill.jpg" alt="" class="mb-2 w-full rounded-md" />
		<enhanced:img src="/static/nchoice/4.jpg" alt="" class="mb-2 w-full rounded-md" />
		<enhanced:img src="/static/nchoice/1.jpg" alt="" class="mb-2 w-full rounded-md" />
		<div
			class="mb-2 flex items-start justify-center gap-2 overflow-hidden rounded-md bg-zinc-50 px-12 py-8 md:px-48 md:py-36"
		>
			<img src="/nchoice/8.jpg" alt="" class="w-full rounded-sm" />
		</div>
		<enhanced:img src="/static/nchoice/7.jpg" alt="" class="mb-2 w-full rounded-md" />
		<enhanced:img src="/static/nchoice/10.jpg" alt="" class="mb-2 w-full rounded-md" />
	</div>
