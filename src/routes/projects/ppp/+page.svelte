<div class="flex flex-wrap-reverse">
	...
	<div class="px-4 pr-4 pt-32 md:w-1/3 md:px-2 md:py-1">
		<div class="sticky top-1">
			<h1 class="mb-4 text-balance text-5xl opacity-35 md:mb-12 md:text-xl">Print Paper Production</h1>
			<div class="mb-8 md:-ml-2 md:mb-4 md:mr-2">
				<div class="w-full rounded-md bg-neutral-50 p-2 text-[1rem] leading-[1.2]">
                    ...
                    <p>
						Involvement:<br />
						<span class="opacity-50">Web Design & Development, System Design, UI/UX, Automation, Copywriting</span>
					</p>
					<br />
					<p>
						Team:<br />
